...
class Record {
    ...
    function getTopRecordsByNivel($nivel) {
      $query = "SELECT nombre, apellido, tiempo FROM REGISTRO WHERE nivel = ? ORDER BY tiempo ASC LIMIT 10";
      ...
      $sentencia->bind_result($nombre, $apellido, $tiempo);

      $resultados = '';
      while ($sentencia->fetch()) {
          $resultados .= "Nombre: $nombre, Apellido: $apellido, Tiempo: $tiempo\t";
      }
...
// Resto del contenido del archivo crucigrama.php
  ...
  echo $record -> getTopRecordsByNivel($nivel);
}
?>
<!DOCTYPE html>
<html lang="en">
